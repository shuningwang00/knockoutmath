...
export default function GetToKnowSection() {
  return (
    <section className="bg-[#9333ea] p-3 md:p-5">
      <div className="grid md:grid-cols-2">
        ...
        <div className="bg-[#f6f4ef] px-6 py-10 md:px-10 md:py-12 lg:px-14 lg:py-16">
          <h2 className="font-heading text-3xl font-black uppercase tracking-tight text-black md:text-4xl">
            Get To Know Us
          </h2>

          <p className="font-body mt-6 text-base leading-relaxed text-zinc-800 md:text-[1.05rem]">
          ...
          <p className="font-body mt-5 text-base leading-relaxed text-zinc-800 md:text-[1.05rem]">
          ...
          <p className="font-body mt-8 text-base leading-relaxed text-zinc-800 md:text-[1.05rem]">
